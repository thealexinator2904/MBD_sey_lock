...
## Generated on : Fri Jan 08 12:27:41 2021
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/Uni/FH-Johanneum-Graz/MBD/MBD_sey_lock/MatLab
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
ert_main.o : $(START_DIR)/keypad_template_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


keypad_template.o : $(START_DIR)/keypad_template_ert_rtw/keypad_template.c
	$(CC) $(CFLAGS) -o "$@" "$<"
