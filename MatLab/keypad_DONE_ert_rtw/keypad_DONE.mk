###########################################################################
## Makefile generated for Simulink model 'keypad_DONE'. 
## 
## Makefile     : keypad_DONE.mk
## Generated on : Wed Jan 06 14:10:53 2021
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/keypad_DONE.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/keypad_DONE.elf
...
DEFINES_ = -DMODEL=keypad_DONE -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=1 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=keypad_DONE -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/keypad_DONE_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/keypad_DONE_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/keypad_DONE_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/keypad_DONE_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


keypad_DONE.o : $(START_DIR)/keypad_DONE_ert_rtw/keypad_DONE.c
	$(CC) $(CFLAGS) -o "$@" "$<"


keypad_DONE_data.o : $(START_DIR)/keypad_DONE_ert_rtw/keypad_DONE_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


keypad_sfcn_wrapper.o : $(START_DIR)/keypad_sfcn_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
